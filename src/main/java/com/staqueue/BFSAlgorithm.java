...
public class BFSAlgorithm extends JPanel
    ...
    public BFSAlgorithm() {
        ...
        canvas = new MinimumSpanningTree(this);
        canvas.addMouseListener(this);
        canvas.addMouseMotionListener(this);

        Dimension canvasSize = new Dimension(1100,600);
        ...
        Dimension panelSize = new Dimension(1100,100);
        ...
        weight.setMinimumSize(new Dimension(150, 40));
        weight.setPreferredSize(new Dimension(150, 40));
        weight.setMaximumSize(new Dimension(150, 40));
        ...
        computeMstButton = new JButton("Compute BFS");
        ...
        buttonPanel2.add(addVertexButton);
        buttonPanel2.add(Box.createHorizontalGlue());
        // buttonPanel1.add(removeVertexButton);
        buttonPanel2.add(Box.createHorizontalGlue());
        buttonPanel2.add(addEdgeButton);
        buttonPanel2.add(Box.createHorizontalGlue());
        // buttonPanel1.add(removeEdgeButton);
        buttonPanel2.add(Box.createHorizontalGlue());

        buttonPanel1.add(Box.createHorizontalGlue());
        buttonPanel1.add(setEdgeWeightButton);
        buttonPanel1.add(Box.createHorizontalGlue());
        buttonPanel1.add(weight);
        buttonPanel1.add(Box.createHorizontalGlue());
    ...
    // BFSAlgorithm project = new BFSAlgorithm();
	...
	if (buttonIdentifier.equals("addVertex")) {
        ...
        mst = new MinimumSpanningTree(edges).getMST();
        canvas.repaint();
    }
